...
const TYPE_META: Record<string, { label: string; color: string; href: string }> = {
  PROJECT:     { label: 'Project',     color: '#06b6d4', href: '/solutions/projects' },
  DEMO:        { label: 'Pilot',       color: '#06b6d4', href: '/solutions/pilots' },
  PARTNERSHIP: { label: 'Partnership', color: '#06b6d4', href: '/solutions/partnership' },
  INTERN:      { label: 'Intern',      color: '#06b6d4', href: '/solutions/intern' },
  PRODUCT:     { label: 'Producto',    color: '#06b6d4', href: '/solutions/productos' },
}
