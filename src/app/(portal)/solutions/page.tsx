...
const TYPE_META: Record<string, { label: string; color: string; href: string }> = {
  PROJECT:     { label: 'Project',     color: '#f97316', href: '/solutions/projects' },
  DEMO:        { label: 'Pilot',       color: '#f97316', href: '/solutions/pilots' },
  PARTNERSHIP: { label: 'Partnership', color: '#f97316', href: '/solutions/partnership' },
  INTERN:      { label: 'Intern',      color: '#f97316', href: '/solutions/intern' },
