...
function Styles() {
  return (
    <style>{`
      ...
      .sala-control .app { display: flex; flex-direction: column; min-height: 100vh; }
      .sala-control .topbar { display: flex; align-items: center; gap: 20px; padding: 16px 24px; border-bottom: 1px solid var(--border); background: var(--surface); flex-wrap: wrap; }
      ...
      .sala-control .breadcrumb .code { font-size: 12px; padding: 2px 7px; border-radius: 5px; background: var(--surface-2); color: var(--text); border: 1px solid var(--border); }
      .sala-control .breadcrumb .sep { color: var(--text-faint); }
      ...
      .sala-control .stage-title { font-size: 12px; font-weight: 700; text-transform: uppercase; letter-spacing: .08em; color: var(--text-faint); }
      .sala-control .legend { display: flex; gap: 14px; font-size: 12px; color: var(--text-muted); }
      ...
      .sala-control .stage { position: relative; background: var(--stage-bg); border: 1px solid var(--border); border-radius: 14px; overflow: auto; background-image: linear-gradient(var(--stage-grid) 1px, transparent 1px), linear-gradient(90deg, var(--stage-grid) 1px, transparent 1px); background-size: 28px 28px; max-height: 60vh; }
      ...
      .sala-control .trace-panel { flex: 1; display: flex; flex-direction: column; background: var(--surface); border: 1px solid var(--border); border-radius: 14px; overflow: hidden; }
      .sala-control .trace-head { display: flex; align-items: center; gap: 12px; padding: 12px 16px; border-bottom: 1px solid var(--border); background: var(--surface-2); flex-wrap: wrap; }
